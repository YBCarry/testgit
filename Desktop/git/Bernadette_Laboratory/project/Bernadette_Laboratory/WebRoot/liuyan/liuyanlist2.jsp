        ...
        <tr>
          ...
          <td>
            <a  href="${url2 }update3?id=${bean.id }&menu=${menu }">查看</a> 
        	 ...
        	 <a  href="${url2 }update?id=${bean.id }&menu=${menu }" onclick="{if(confirm('确认回复?')){return true;}return false;}">回复</a>
        	 
        	 <a  href="${url2 }delete2?id=${bean.id }&menu=${menu }" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a>
          </td>
        </tr>
        </c:forEach>
