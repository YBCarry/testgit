...
<div class="well">
    ...
    <form id="tab"	method="post" action="${url }" onsubmit="return checkform()" enctype="multipart/form-data">
        ...
        <label>留言标题</label>
        <input type="text" name="ltitle" id="ltitleid" class="input-xlarge" value="${bean.ltitle }" readonly="readonly" >
        ...
        <label>回复</label>
        <textarea rows="7" cols="50"  name="neirong"  readonly="readonly">${bean.huifu }</textarea>
