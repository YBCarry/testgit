...
<div class="well">
    ...
    <form id="tab"	method="post" action="${url }" onsubmit="return checkform()" enctype="multipart/form-data">
        ...
        <label>实验室类型</label>
        <input type="text" name="leixing" id="leixingid" class="input-xlarge"  value="${bean.leixing }" readonly="readonly">
        
      
		
		<label>名称</label>
        <input type="text" name="mingchen" id="mingchenid" class="input-xlarge" value="${bean.mingchen }" readonly="readonly">

		<label>限制人数</label>
        <input type="text" name="renshu" id="renshuid" class="input-xlarge" value="${bean.renshu }" readonly="readonly">
	
       <label>负责人</label>
        <input type="text" name="fzr" id="fzrid" class="input-xlarge" value="${bean.fzr }" readonly="readonly">
