...
<div class="well">
    ...
    <form id="tab"	method="post" action="${url }" onsubmit="return checkform()" enctype="multipart/form-data">
        ...
        <label>实验室类型</label>
        <input type="text" name="leixing" id="leixingid" class="input-xlarge">
        
      
		
		<label>名称</label>
        <input type="text" name="mingchen" id="mingchenid" class="input-xlarge">
       ...
       <label>负责人</label>
        <input type="text" name="fzr" id="fzrid" class="input-xlarge">
        
        <label>负责人电话</label>
        <input type="text" name="dianhua" id="dianhuaid" class="input-xlarge">
        
        
        <label>实验室简介</label>
        <textarea class="ckeditor" rows="7" cols="50"  name="jianjie"></textarea>
